      ...
      <div className="grid grid-cols-4 gap-2">
        {actions.map(a => (
          <button
            key={a.label}
            onClick={a.onClick}
            className="group flex flex-col items-center gap-2 p-2 rounded-2xl hover:bg-muted/60 transition"
          >
            <div className={`w-12 h-12 rounded-2xl ${a.tint} flex items-center justify-center shadow-sm group-hover:-translate-y-0.5 group-hover:shadow-md transition-all`}>
              <a.icon size={20} className={a.icon_color} strokeWidth={2.2} />
            </div>
